...
if("TRUE" STREQUAL "TRUE")
  set(tf2_tools_SOURCE_PREFIX /home/hdcl-ros/ballbotRepo/src/geometry2/tf2_tools)
  set(tf2_tools_DEVEL_PREFIX /home/hdcl-ros/ballbotRepo/devel/.private/tf2_tools)
  ...
  set(tf2_tools_INSTALL_PREFIX /home/hdcl-ros/ballbotRepo/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hdcl-ros/ballbotRepo/src/geometry2/tf2_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hdcl-ros/ballbotRepo/devel/.private/tf2_tools/lib;/home/hdcl-ros/ballbotRepo/devel/lib;/opt/ros/melodic/lib)
